...
\noindent Tällainen lähestymistapa johtaa ruuhkatilanteissa helposti oudolta näyttävään poukkoiluun, ja sen myötä prosessoriajan hävikkiin laskettaessa reitti jokaisen yhteentörmäyksen yhteydessä uudestaan.
...
Tämä vuoden 2011 algoritmi hyödyntää puurakenteita ja olemassaolevien ei-puumaisten graafien konvertoimiseen onkin kehittäjien toimesta luotu \textit{Graph-to-Tree Decomposition (GTD)} -algoritmeja. TASS on kehitetty erityisesti tilanteisiin, joissa vapaata liikkumatilaa on hyvin vähän.\newline
...
Suurempi haarautuvuus nopeuttaa algoritmin toimintaa, koska tämä keskimäärin lyhentää etäisyyttä lähimpään sellaiseen paikkaan puussa, missä uudelleenjärjestely voidaan suorittaa~\cite{khorshid2011polynomial}.
...
\noindent Ohjelmoijan vastuulle jääkin pohtia topologiaa, toimijoiden lukumäärää ja laskentanopeuden tarvetta sopivaa reitinhakualgoritmia valitessaan. Kaikkiin tilanteisiin sopivaa yleisalgoritmia ei ole olemassa, eikä sellaista kenties ole mahdollista toteuttaakaan.
