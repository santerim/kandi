...
CBS-algoritmin toiminta on tehotonta esimerkiksi tilanteessa 
...
Guni Sharonin ja kumppaneiden vuonna 2012 julkaisema ICTS-algoritmi on kaksitasoista hierarkiaa hyödyntävä algoritmi~\cite{sharon2013}. Hierarkian ylemmällä tasolla käydään läpi puuta nimeltä \textit{increasing cost tree}. Se muodostuu solmuista, joista jokaisessa oleva taulukko edustaa kaikkia niitä mahdollisia reittiratkaisuja, missä toimijoiden reittien hinta on täsmälleen taulukkoon niitä vastaaville paikoille generoitu luku. Toisin sanoen kyseessä on taulukko $[C_1,...,C_k]$, jossa toimijan $a_i$ reittikustannus löytyy taulukon kohdasta $C_i$.
