...
\classification{
$\bullet$~Computing methodologies $\rightarrow$ Artificial intelligence $\rightarrow$ Control methods $\rightarrow$ Motion path planning,

\noindent$\bullet$~Computing methodologies $\rightarrow$ Artificial intelligence $\rightarrow$ Planning and scheduling $\rightarrow$ Multi-agent planning
}
